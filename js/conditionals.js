...
function analyzeColor(colorName) {
    if (colorName === 'blue') {
        ...
        return "I do not recognize that color. - " + colorName
    }
}
 ...
 */
    switch(analyzeColor(randomColor)) {
        case "blue" :
 ...
 */
    var userInput = prompt("Give me a color off the top of your head");
...
if (userAnswer) {
    ...
    if (isNaN(userNumber)) {
        ...
        alert("100 + your number is :" + Number(100+userNumber));
        if (userNumber < 0) {
